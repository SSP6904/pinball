...
function registerGamepadEventCallback(
  ...
  var gamepadEventHandlerFunc = function (ev) {
    ...
    if (
      wasmTable.get(callbackfunc) (eventTypeId, gamepadEvent, userData)
    ) e.preventDefault()
  };
  var eventHandler = {
    target: findEventTarget(target),
...
function registerKeyEventCallback(
  ...
  var keyEventHandlerFunc = function (e) {
    ...
    if (
      wasmTable.get(callbackfunc) (eventTypeId, keyEventData, userData)
    ) e.preventDefault()
  };
  var eventHandler = {
    target: findEventTarget(target),
...
var ___wasm_call_ctors = Module['___wasm_call_ctors'] = function () {
  return (
    ___wasm_call_ctors = Module['___wasm_call_ctors'] = Module['asm']['Hd']
...
var ___errno_location = Module['___errno_location'] = function () {
  return (
    ___errno_location = Module['___errno_location'] = Module['asm']['Md']
  ).apply(null, arguments)
};
...
var ___embind_register_native_and_builtin_types = Module['___embind_register_native_and_builtin_types'] = function () {
  return (
    ___embind_register_native_and_builtin_types = Module['___embind_register_native_and_builtin_types'] = Module['asm']['Od']
  ).apply(null, arguments)
};
